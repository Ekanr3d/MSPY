			...
			<section class="home-head">
				...
				<div class="wrap">
					<div class="align_center">
						...
						<a id="HomeBtnBuynow" class="btn arow" href="http://mspy.go2cloud.org/SH2rP<?php if(!empty($_COOKIE['OPID'])){echo '?source='.$_COOKIE['OPID'];}else if(empty($_COOKIE['OPID']) && empty($operatorId)){}else{echo '?source='.$operatorId;}?>">შეიძინე ახლავე</a>
					</div>
				</div>
			</section>
			<div class="wrap">
										...
										<div class="cover top">
											<div class="grey_block">
												...
												<div class="item-description">
													...
													<p class="text1" style="margin: -5px 8px;">mSpy გაძლევთ საშუალებას აკონტროლოთ თქვე-ნი შვილების გადადგილება და, შესაბამისად, აღ-არ ინერვიულოთ მათ უსაფრთხოებაზე.</p>
												</div>
											</div>
										</div>
										<div class="cover bot">
											...
											<div class="grey_block">
												...
												<div class="item-description">
													...
													<p class="text1">
															...
															გაუწიეთ მონიტორინ-გი თუ სად და რომელ გვერდებზე შედიან, დაათ-ვალიერეთ ბროუზერის ისტორია, 
										...
										<div class="cover top">
											<div class="grey_block">
												...
												<div class="item-description">
													...
													დარწმუნდი კომპიუტერის შესაბამის აქტივობებ-ში სქინშოთების გადაღების გზით, 
													რომელსაც უზ-რუნველყოფს mSpy-ს მონიტორინგის სისტემა თქვენთვის სასურველი ინტერვალებით.</p>
												</div>
											</div>
										</div>
										<div class="cover bot">
										...
										<div class="cover top">
											<div class="grey_block">
												...
												<div class="item-description">
													...
													<p class="text1" style="margin: 10px 8px;">ნახეთ რამდენი ხანი იყო კომპიუტერთან მმჯდო-მი თქვენი კონტროლის ქვეშ მყოფი უზერი აქტი-ურ/ პასიურ რეჯიმში.</p>
												</div>
											</div>
										</div>
										<div class="cover bot">
